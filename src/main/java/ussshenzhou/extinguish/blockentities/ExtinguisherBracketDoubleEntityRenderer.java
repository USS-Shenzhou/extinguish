 ...
 * @author Tony Yu
 */
public class ExtinguisherBracketDoubleEntityRenderer implements BlockEntityRenderer<ExtinguisherBracketDoubleEntity> {
    public ExtinguisherBracketDoubleEntityRenderer(BlockEntityRendererProvider.Context pContext) {
    }

    @Override
    public void render(ExtinguisherBracketDoubleEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        ...
        if (itemStacks[0] != ItemStack.EMPTY) {
            ...
            switch (pBlockEntity.getBlockState().getValue(BlockStateProperties.FACING)) {
                case NORTH:
                    pPoseStack.translate(12 / 16f, 0, 11 / 16f);
                    pPoseStack.mulPose(Vector3f.YP.rotationDegrees(180));
                    break;
                case SOUTH:
                    pPoseStack.translate(4 / 16f, 0, 5 / 16f);
                    break;
                case EAST:
                    pPoseStack.translate(5 / 16f, 0, 12 / 16f);
                    pPoseStack.mulPose(Vector3f.YP.rotationDegrees(90));
                    break;
                case WEST:
                    pPoseStack.translate(11 / 16f, 0, 4 / 16f);
        ...
        if (itemStacks[1] != ItemStack.EMPTY) {
            ...
            switch (pBlockEntity.getBlockState().getValue(BlockStateProperties.FACING)) {
                case NORTH:
                    pPoseStack.translate(4 / 16f, 0, 11 / 16f);
                    pPoseStack.mulPose(Vector3f.YP.rotationDegrees(180));
                    break;
                case SOUTH:
                    pPoseStack.translate(12 / 16f, 0, 5 / 16f);
                    break;
                case EAST:
                    pPoseStack.translate(5 / 16f, 0, 4 / 16f);
                    pPoseStack.mulPose(Vector3f.YP.rotationDegrees(90));
                    break;
                case WEST:
                    pPoseStack.translate(11 / 16f, 0, 12 / 16f);
                    pPoseStack.mulPose(Vector3f.YP.rotationDegrees(270));
                    break;
                default:
                    break;
